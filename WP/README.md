...
Visualisierung einer Wärmepumpe in IP-Symcon.
...
- Zusätzlich zu den Heizstäben im Warmwasserspeicher wird im Bedienfeld entsprechend ein Icon eingeblendet falls Heizstäbe konfiguriert sind.
